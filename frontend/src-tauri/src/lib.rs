...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Diarization model download consent gate
            diarization::commands::get_diarization_consent,
            ...
            diarization::commands::set_diarization_auto_run,
            diarization::commands::delete_diarization_models,
            ...
            summary::commands::api_get_meeting_transcription_language,
